            ...
            <ol class="items-center justify-center w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0">
                ...
                <form action="{{ route('postCreateStepOne') }}" method="POST">
                    ...
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white border border-gray-300 px-2 py-1" id="reserverid" name="reserverid" type="text">
                    ...
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white border border-gray-300 px-2 py-1" id="contactnumber" name="contactnumber" type="text">
                    ...
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-2/3">
                            <input class="form-input block w-full focus:bg-white border border-gray-300 px-2 py-1" id="email" name="email" type="text" >
